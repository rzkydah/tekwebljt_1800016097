...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 14, vars: 1, consts: [["color", "primary"], [1, "spacer"], ["mat-button", "", 3, "click"], [1, "container"], [4, "ngFor", "ngForOf"], ["matListAvatar", "", "src", "assets/icon.jpg", "alt", "..."], ["matLine", ""], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\ASUS\buku-alamat\src\main.ts */"./src/main.ts");
